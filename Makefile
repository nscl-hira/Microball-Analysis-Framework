...
.PHONY: clean
clean:
        @$(RM) -f $(OBJS) $(ROOTHTMB_DICT) $(ROOTHTMB_PCM) $(ROOTHTMB_DICTO) $(ROOTHTMB_DICTH) $(ROOTHTMB_DICTH) $(ROOTMBCALIBRATED_DICT) $(ROOTMBCALIBRATED_PCM)
        @echo "$(RM) -f $(OBJS) $(ROOTHTMB_DICT) $(ROOTHTMB_PCM) $(ROOTHTMB_DICTO) $(ROOTHTMB_DICTH) $(ROOTMBCALIBRATED_DICT) $(ROOTMBCALIBRATED_PCM)"
